...
export default async function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-on-surface grid-bg flex items-center justify-center px-6 py-16 relative overflow-x-hidden">
      ...
      <div className="flex w-full max-w-md flex-col items-center gap-5">
        <div className="inline-flex items-center gap-2 rounded-full glass-panel px-3 py-1.5 text-xs text-on-surface-variant animate-[slide-down_0.55s_ease_both]">
          <span className="material-symbols-outlined text-[16px] text-primary">globe_book</span>
          <span className="font-label">Travel Buddy</span>
        </div>
        <div className="w-full animate-[fade-up_0.6s_ease_both]">
